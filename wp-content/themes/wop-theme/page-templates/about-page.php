    ...
    <header class="page-header section-padding pb-0">
        <div class="container mt-80">
            <div class="row">
                <div class="col-lg-8">
                    <div class="caption">
                        <h6 class="sub-title"><?= pll__('Who We Are ?');?></h6>
                        <h1 class="fz-55">
                            <?= $about_us['heading'] ?>
                        </h1>
                    </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-4">
                    <div class="sec-head mt-80">
                        <h6 class="sub-title"><?= pll__('Our Story');?></h6>
                    </div>
                </div>
                <div class="col-lg-8">
                        ...
                        <div class="text">
                            <h2 class="d-slideup wow">
                                <span class="sideup-text">
                                    <span class="up-text"><?= pll__('Our Mission');?></span>
                                </span>
                            </h2>
                        </div>
        ...
        <div class="container">
            <div class="row justify-content-center mb-80">
                <div class="col-lg-6 text-center">
                    <div class="text">
                        <h3><?= pll__('We Strategic Partners');?></h3>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="col-11 d-flex align-items-center">
                    <div class="valign">
                        <h2 class="fz-50 d-rotate wow">
                            ...
                            <span class="rotate-text"><?= pll__('Let’s Learn about products');?></span>
                        </h2>
                    </div>
                    <div class="ml-auto">
                        <a href="<?= $about_products['redirect_link']?>" class="butn-circle d-flex align-items-center text-center m-auto">
                            <div class="full-width">
                                ...
                                <span class="full-width"><?= pll__('Learn about products');?></span>
                            </div>
